<div id="d15-app-container" style="background-color: #0D1117; padding: 25px; border-radius: 12px; font-family: system-ui, sans-serif; color: white; user-select: none;">
    ...
    <!-- FIXED: Added standard flex wrapping and explicit item boundaries -->
...
function renderSlots() {
    ...
    slotStorage.forEach((capId, slotIdx) => {
        ...
        // FIXED: Hard-coded box layout settings to force absolute identical round dimensions
        ...
        // Drag Over and Drop configurations
...
function renderPile() {
    ...
    // Drop back into source pile logic
...
document.getElementById("d15-app-container").addEventListener("click", () => {
    resetHighlights();
    clearSelection();
});

document.getElementById("score-btn").addEventListener("click", (e) => {
    e.stopPropagation();
