...
# 🔒 YOUR TOUCHED WORKING DRAG-AND-DROP CANVAS CONTAINER (Completely Closed and Protected)
html_data = (
...
# ====================================================================
# 🔬 SAFE ISOLATED INVOKER REGION (Sits cleanly outside the string)
# ====================================================================
st.markdown("### 🔬 Advanced Diagnostic Engine Panel")
st.write("Input the score generated by the layout tool above to map it against diagnostic thresholds.")

# Creates an independent input field
manual_score = st.number_input("Enter Total Error Score (TES) from above to evaluate:", min_value=0, max_value=200, value=0, step=1)
